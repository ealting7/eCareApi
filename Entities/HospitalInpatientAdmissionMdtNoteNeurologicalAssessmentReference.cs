...
{
    [Table("HOSPITAL_INPATIENT_ADMISSION_MDT_NOTE_NEUROLOGICAL_ASSESSMENT_REFERENCE")]
    public class HospitalInpatientAdmissionMdtNoteNeurologicalAssessmentReference
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int hosptial_inpatient_admission_mdt_note_neurological_assessment_reference_id { get; set; }
